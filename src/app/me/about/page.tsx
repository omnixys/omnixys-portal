...
import { ExperienceTimeline } from "../../../components/me/ExperienceTimeline";
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* SKILLS */}
          <Box ref={skillRef} display="flex" flexDirection="column" gap={3}>
            <MotionTypography
              variant="h5"
              fontWeight="bold"
              initial={{ x: -300 }}
          ...
          >
            ...
            <ExperienceTimeline inView={isExperienceInView} />
          </Box>
        </Box>
