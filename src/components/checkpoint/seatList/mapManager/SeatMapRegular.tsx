...
import VisionStrip from "@/components/checkpoint/seatList/vision/VisionStrip";
import VisionStripItem from "@/components/checkpoint/seatList/vision/VisionStripItem";
