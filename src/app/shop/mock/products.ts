export const PRODUCTS = [
  ...
  },
  {
    ...
    price: 15.99,
    description:
      "Please note that body builds vary by person, therefore detailed size information should be reviewed below.",
    category: "men's clothing",
  ...
  },
  {
    ...
    price: 64,
    description: "USB 3.0 and USB 2.0 compatibility with fast data transfers.",
  ...
  },
  {
    ...
    price: 109,
    description:
      "High transfer speeds and improved overall system performance.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 114,
    description:
      "Expand your PS4 gaming experience with high capacity storage.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 599,
    description: "Ultra-thin design with 75Hz refresh rate and IPS panel.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 999.99,
    description: "Super ultrawide curved gaming monitor with QLED technology.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 29.95,
    description: "Removable hooded faux leather jacket for style and comfort.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 39.99,
    description:
      "Lightweight raincoat with hood and adjustable drawstring waist.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 7.95,
    description: "Lightweight, breathable fabric with moisture wicking.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 12.99,
    description: "Soft cotton fabric with stretch, suitable for all seasons.",
    category: "women's clothing",
