...
// Phase 3 components
import EntryExitHistory from "@/components/checkpoint/security/EntryExitHistory";
import GuestsInsideList from "@/components/checkpoint/security/GuestsInsideList";
import SecurityAnalyticsCharts from "@/components/checkpoint/security/SecurityAnalyticsCharts";
