...
import GateOverviewHeatmap from "@/components/checkpoint/security/GateOverviewHeatmap";
import SecurityQuickToolsPanel from "@/components/checkpoint/security/SecurityQuickToolsPanel";
import TicketVerificationTool from "@/components/checkpoint/security/TicketVerificationTool";
